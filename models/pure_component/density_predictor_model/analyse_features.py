...
def analyze_selected_features(selector_path='density_model/artifacts/selector.joblib'):
    """
    ...
    # Save summary
    summary_path = "density_model/feature_selection_summary.txt"
    ...
    if len(selected_descriptors) > 0:
        ...
        desc_csv_path = "density_model/selected_descriptors.csv"
...
def plot_feature_distribution(selector_path='density_model/artifacts/selector.joblib'):
    """
    ...
    plot_path = "density_model/feature_selection_visualization.png"
...
def get_feature_importance_from_model(model_path='density_model/artifacts/model.joblib',
    ...
    importance_path = "density_model/feature_importances.csv"
...
def plot_top_features(importance_df, top_n=20):
    ...
    plot_path = "density_model/top_features.png"
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
...
def main():
    ...
    if results:
        ...
        print("="*70)
        print("\nGenerated files:")
        print("  - density_model/feature_selection_summary.txt")
        print("  - density_model/selected_descriptors.csv")
        print("  - density_model/feature_selection_visualization.png")
        print("  - density_model/feature_importances.csv")
        print("  - density_model/top_features.png")
        print("="*70)
