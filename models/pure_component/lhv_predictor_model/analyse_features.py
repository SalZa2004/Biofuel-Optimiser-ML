...
def analyze_selected_features(selector_path='lhv_model/artifacts/selector.joblib'):
    """
    ...
    # Save summary
    summary_path = "lhv_model/feature_selection_summary.txt"
    ...
    if len(selected_descriptors) > 0:
        ...
        desc_csv_path = "lhv_model/selected_descriptors.csv"
...
def plot_feature_distribution(selector_path='lhv_model/artifacts/selector.joblib'):
    """
    ...
    plot_path = "lhv_model/feature_selection_visualization.png"
...
def get_feature_importance_from_model(model_path='lhv_model/artifacts/model.joblib',
    ...
    importance_path = "lhv_model/feature_importances.csv"
...
def plot_top_features(importance_df, top_n=20):
    ...
    plot_path = "lhv_model/top_features.png"
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
...
def main():
    ...
    if results:
        ...
        print("="*70)
        print("\nGenerated files:")
        print("  - lhv_model/feature_selection_summary.txt")
        print("  - lhv_model/selected_descriptors.csv")
        print("  - lhv_model/feature_selection_visualization.png")
        print("  - lhv_model/feature_importances.csv")
        print("  - lhv_model/top_features.png")
        print("="*70)
