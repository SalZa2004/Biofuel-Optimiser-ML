...
def analyze_selected_features(selector_path='dynamic_viscosity_model/artifacts/selector.joblib'):
    print("="*70)
    ...
    os.makedirs("dynamic_viscosity_model/feature_information", exist_ok=True)

    summary_path = "dynamic_viscosity_model/feature_information/feature_selection_summary.txt"
    ...
    if len(selected_descriptors) > 0:
        ...
        desc_csv_path = "dynamic_viscosity_model/feature_information/selected_descriptors.csv"
...
def plot_feature_distribution(selector_path='dynamic_viscosity_model/artifacts/selector.joblib'):
    if not os.path.exists(selector_path):
        return
    ...
    plot_path = "dynamic_viscosity_model/feature_information/feature_selection_visualization.png"
...
def get_feature_importance_from_model(
    ...
    importance_path = "dynamic_viscosity_model/feature_information/feature_importances.csv"
...
def plot_top_features(importance_df, top_n=20):
    ...
    plot_path = "dynamic_viscosity_model/feature_information/top_features.png"
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
...
def main():
    ...
    if results:
        ...
        print("="*70)
        print("\nGenerated files:")
        print("  - dynamic_viscosity_model/feature_information/feature_selection_summary.txt")
        print("  - dynamic_viscosity_model/feature_information/selected_descriptors.csv")
        print("  - dynamic_viscosity_model/feature_information/feature_selection_visualization.png")
        print("  - dynamic_viscosity_model/feature_information/feature_importances.csv")
        print("  - dynamic_viscosity_model/feature_information/top_features.png")
        print("="*70)
