...
from train import CetanePredictor, featurize_df, FeatureSelector
import joblib

# Same database path as training
...
def main():
    ...
    plot_results(y_true, y_pred, save_path="cn_model/evaluation_plots.png")
